int main(int argc, char const *argv[]){
    ...
    do{
        ...
        cout << "-------------------------------------------------------" << endl;
        cout << "--------------OPÇÕES PAR CONVERSÃO--------------------" << endl;
        ...
        switch(op){
        	case 1:
        		cout << "-------------------------------------------------------" << endl;
                cout << " Informe um valor númerico:" << endl;
                cin >> valor;
                cout << "-------------------------------------------------------" << endl;
                break;
            case 2:
                ...
                cout << "-------------------------------------------------------" << endl;
                cout << " VALOR: " <<;  //conversao->decimalBinario();
                break;
            case 3:
            	cout << "-------------------------------------------------------" << endl;
                cout << "\t CONVERSÃO DE DECIMAL X HEXADECIMAL" << endl;
                cout << "-------------------------------------------------------" << endl;
                cout << " VALOR: " <<;  //conversao->decimalHexadecimal();
                break;
            case 4:
            	cout << "-------------------------------------------------------" << endl;
            ...
            case 13:
                ...
                break;
            case 0: cout << "\t PROGRAMA ENCERRADO COM SUCESSO!\n \t VOLTE SEMPRE!" << endl;
                break;
            default:
