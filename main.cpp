...
int main(int argc, char const *argv[]){
    ...
    do{
        ...
        cout << "-----------------------------------------------------------------------" << endl;
        cout << "  2 -- DECIMAL PARA BINÁRIO       |   8  -- HEXADECIMAL PARA DECIMAL" << endl;
        cout << "  3 -- DECIMAL PARA HEXADECIMAL   |   9  -- HEXADECIMAL PARA BINÁRIO" << endl;
        cout << "  4 -- DECIMAL PARA OCTAL         |   10 -- HEXADECIMAL PARA OCTAL" << endl;
        cout << "  5 -- BINÁRIO PARA DECIMAL       |   11 -- OCTAL PARA DECIMAL" << endl;
        cout << "  6 -- BINÁRIO PARA HEXADECIMAL   |   12 -- OCTAL PARA HEXADECIMAL" << endl;
        cout << "  7 -- BINÁRIO PARA OCTAL         |   13 -- OCTAL PARA BINÁRIO" << endl;
        cout << "  0 -- SAIR " << endl;
        cout << "-----------------------------------------------------------------------" << endl;
        cout << "OPÇÃO: ";
        cin >> op;
        ...
        switch(op){
            ...
            case 5:
                ...
                cout << "-------------------------------------------------------" << endl;
                //conversao->binarioDecimal(valor);
                cout << endl;
                break;
            case 6:
            	cout << "-------------------------------------------------------" << endl;
